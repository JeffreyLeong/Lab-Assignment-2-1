...
int main(){
    ...
    do {
        ...
        cout << "+ There are " << positive << " positive numbers, sum = " << positive_sum << " and average = " << positive_average << endl;
        cout << "+ There are " << negative << " negative numbers, sum = " << negative_sum << " and average = " << negative_average << endl;
